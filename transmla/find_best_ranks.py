...
from lora_qkv_find import low_rank_qkv_find
...
def main(args):
    ...
    ##############################
    print("\n" + "="*60)
    print("搜索最佳 kv_lora_rank".center(60))
    print("="*60 + "\n")

    model, search_results = low_rank_qkv_find(model, tokenizer, train_loader, test_loader, **vars(args))

    # 保存搜索结果到文件
    if args.save_results:
        import json
        results_file = os.path.join(args.save_results, "kv_rank_search_results.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-results", type=str, default="search_results", help="Directory to save search results.")
    ...
    parser.add_argument("--ppl-tolerance", type=float, default=0.05, help="PPL tolerance for accepting lower ranks (default: 0.1)")
